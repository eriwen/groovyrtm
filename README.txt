...
You need 2 things to create a app using GroovyRTM:
   ...
   2. Apply for an API key at
    http://www.rememberthemilk.com/services/api/keys.rtm (And an RTM account to
    test)
...
Download a NetBeans project setup with the latest GroovyRTM JAR and optimal
project structure here. Project also includes RTM authorization code to help you
start even faster!
