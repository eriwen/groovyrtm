...
public class GroovyRtm {
    ...
    GroovyRtm(String key, String sharedSecret, String permissions = 'delete') {
        lastCallTimeMillis = new Date().time
        prefs = Preferences.userNodeForPackage(GroovyRtm.class)
        parser = new RtmCollectionParser()
        utils = new GroovyRtmUtils()
     ...
     */
    private getConfigFromFile(String propsFileName) throws IOException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public GPathResult execUnauthenticatedMethod(List params) throws GroovyRtmException {
        synchronized (lastCallTimeMillis) {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public GPathResult execTimelineMethod(List params) throws GroovyRtmException {
        if (!curTimeline) {
    ...
    private String getAuthUrl(frob) {
    ...
    public String authGetToken() {
        ...
        GPathResult rsp = execUnauthenticatedMethod(params)
        String user = rsp.auth.user.@username.toString()
        String token = rsp.auth.token.toString()
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public String contactsAdd(String contact) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public String contactsDelete(String contactId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public String groupsAdd(String groupName) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public String groupsAddContact(String contactId, String groupId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public String groupsDelete(String groupId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public String groupsRemoveContact(String contactId, String groupId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public TaskList listsAdd(String listName, String filter = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public TaskList listsArchive(String listId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public TaskList listsDelete(String listId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public TaskList listsGetListByName(String listName) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public boolean listsSetDefaultList(String listId = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public TaskList listsSetName(String listId, String newName) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public TaskList listsUnarchive(String listId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksAdd(String name, String listId = null,
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksAdd(String name, String priority, String due,
            String estimate, String repeat, String tags, String locationId,
            String url, String listId = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksAddTags(String listId, String taskseriesId,
            String taskId, String tags) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksComplete(String listId, String taskseriesId,
            String taskId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksDelete(String listId, String taskSeriesId,
            String taskId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public List<Task> tasksGetList(String listId = null, String filter = null,
            String lastSync = null) throws GroovyRtmException {
    ...
    public Task tasksMovePriority(String listId, String taskseriesId,
            String taskId, boolean increasePriority) throws GroovyRtmException {
        def direction = 'down'
        if (increasePriority) {
            direction = 'up'
        }
     ...
     */
    public Task tasksMovePriority(String listId, String taskseriesId,
            String taskId, String direction) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksMoveTo(String fromListId, String taskseriesId,
            String taskId, String toListId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksPostpone(String listId, String taskseriesId,
            String taskId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksRemoveTags(String listId, String taskseriesId,
            String taskId, String tags) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksSetDueDate(String listId, String taskseriesId,
            String taskId, String due = null, boolean hasDueTime = false, boolean parse = false) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksSetEstimate(String listId, String taskseriesId,
            String taskId, String estimate = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksSetLocation(String listId, String taskseriesId,
            String taskId, String locationId = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksSetName(String listId, String taskseriesId,
            String taskId, String name) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksSetPriority(String listId, String taskseriesId,
            String taskId, String priority = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksSetRecurrence(String listId, String taskseriesId,
            String taskId, String repeat = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksSetTags(String listId, String taskseriesId,
            String taskId, String tags = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksSetUrl(String listId, String taskseriesId,
            String taskId, String url = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Task tasksUncomplete(String listId, String taskseriesId,
            String taskId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Note tasksNotesAdd(String listId, String taskseriesId,
            String taskId, String noteTitle, String noteText) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public boolean tasksNotesDelete(String noteId) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Note tasksNotesEdit(String noteId, String noteTitle,
            String noteText) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public String timeConvert(String toTimezone,
            String fromTimezone = null, Date time = null) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public String timeParse(String text, String timezoneId = null,
            boolean europeanFormat = false) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public Timezone timezonesGetTimezoneByName(String timezoneName) throws GroovyRtmException {
     ...
     * @throws GroovyRtmException when the HTTP request failed
     */
    public boolean transactionsUndo(String transactionId) throws GroovyRtmException {
